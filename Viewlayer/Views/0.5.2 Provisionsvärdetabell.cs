...
{
    public partial class FormProvisionsvärdetabell : Form
    {
        public FormProvisionsvärdetabell()
        {
            InitializeComponent();
        ...
        // Visar värdena i datagridviewen
        private void btnVisa_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = bm.VisaProvisionstabell();
        }

        // Öppnar en ny form med möjlighet att skapa ny provisionstabell
        private void btnLäggTill_Click(object sender, EventArgs e)
        {
            FormSkapaProvisionstabell nySkapaProvisionstabell = new FormSkapaProvisionstabell();
            nySkapaProvisionstabell.Show();
        }
    }
}
