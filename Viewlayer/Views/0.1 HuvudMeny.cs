...
namespace Viewlayer
{
    // BehörighetsID 
    //      1 = VD
    //      2 = Försäljningschef/Försäljningsassistent
    //      3 = Ekonomiassisten/admin
    //      4 = Säljare
    public partial class FormHuvudMeny : Form
    {
        public FormHuvudMeny()
        {
            InitializeComponent();
            ...
            if (clsBehörighet.Behörighet != 3)
            {
                ...
                visaProvisionsvärdetabellToolStripMenuItem.Enabled = false;
