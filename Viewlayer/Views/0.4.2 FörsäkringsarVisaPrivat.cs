...
{
    public partial class FormFörsäkringsarVisaPrivat : Form
    {
        public FormFörsäkringsarVisaPrivat()
        {
            InitializeComponent();
        ...
        // Tar en skärmbild på befintlig läge på datagridview
        ...
        // Visar värden i listan
        private void btnVisa_Click(object sender, EventArgs e)
        {
            dataGridView1.AutoGenerateColumns = false;
            dataGridView1.DataSource = bm.VisaFörsäkringFörsäkringstagarePrivat();
        }


        // Öppnar en ny form med möjligthet att redigera värderna
        private void btnRedigera_Click(object sender, EventArgs e)
        {
            try
            {

                FormRedigeraPrivatFörsäkringar nyFormRedigeraPrivatFörsäkringar = new FormRedigeraPrivatFörsäkringar();

                nyFormRedigeraPrivatFörsäkringar.Show();

                nyFormRedigeraPrivatFörsäkringar.tbFörsäkringsID.Text = dataGridView1.CurrentRow.Cells[0].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbFörsäkringsnummer.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbProvisionsbelopp.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.dtpBetald.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbAgenturnummer.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbpersonNrFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbförnamnFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbefternamnFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[7].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbgatuadressFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbOrtFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbpostNrFörsäkringstagare.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbtelNrMobil.Text = dataGridView1.CurrentRow.Cells[11].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbtelNrBostad.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbepost1.Text = dataGridView1.CurrentRow.Cells[13].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbepost2.Text = dataGridView1.CurrentRow.Cells[14].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbPersonNrFörsäkrad.Text = dataGridView1.CurrentRow.Cells[15].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbFörnamnFörsäkrad.Text = dataGridView1.CurrentRow.Cells[16].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbefternamnFörsäkrad.Text = dataGridView1.CurrentRow.Cells[17].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbGatuadressFörsäkrad.Text = dataGridView1.CurrentRow.Cells[18].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbOrtFörsäkrad.Text = dataGridView1.CurrentRow.Cells[19].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbpostNrFörsäkrad.Text = dataGridView1.CurrentRow.Cells[20].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbFörsäkringsTyp.Text = dataGridView1.CurrentRow.Cells[21].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbPremie.Text = dataGridView1.CurrentRow.Cells[22].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbBetalningsform.Text = dataGridView1.CurrentRow.Cells[23].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbVuxenBarn.Text = dataGridView1.CurrentRow.Cells[24].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.dtpAnkomstdatum.Text = dataGridView1.CurrentRow.Cells[25].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbGrundbelopp.Text = dataGridView1.CurrentRow.Cells[26].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbTillval.Text = dataGridView1.CurrentRow.Cells[27].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.cbTillvalsbelopp.Text = dataGridView1.CurrentRow.Cells[28].Value.ToString();
                nyFormRedigeraPrivatFörsäkringar.tbFörsäkringsbolag.Text = dataGridView1.CurrentRow.Cells[29].Value.ToString();
        ...
        private void btnSök_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bm.Sökförsäkringprivat(persNr, eNamn);
        }
    }
}
