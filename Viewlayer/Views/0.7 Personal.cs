...
namespace Viewlayer.Views
{
    public partial class FormPersonal : Form
    {
        ...
        // Klick för att få pop up med attribut för att lägga till en personal
        private void btnLäggTill_Click(object sender, EventArgs e)
        {
            var VisaLäggTillPersonal = new FormLäggTillPersonal();
            VisaLäggTillPersonal.Show();
        }

        // Klick för att få pop up med attribut för att redigera till en personal
        private void btnRedigera_Click(object sender, EventArgs e)
        {
            try
            {
                FormRedigeraPersonal nyFormRedigeraPersonal = new FormRedigeraPersonal();
                nyFormRedigeraPersonal.tbAnställningsID.Text = dataGridView1.CurrentRow.Cells[0].Value.ToString();
                nyFormRedigeraPersonal.tbPersNr.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                nyFormRedigeraPersonal.tbAgenturNr.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                nyFormRedigeraPersonal.tbSkattesats.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                nyFormRedigeraPersonal.tbFNnamn.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
                nyFormRedigeraPersonal.tbENamn.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
                nyFormRedigeraPersonal.tbGatuAdress.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                nyFormRedigeraPersonal.tbOrt.Text = dataGridView1.CurrentRow.Cells[7].Value.ToString();
                nyFormRedigeraPersonal.tbPostNr.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
                nyFormRedigeraPersonal.tbTelNrMobil.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
                nyFormRedigeraPersonal.tbTelNrBostad.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
                nyFormRedigeraPersonal.tbEpost.Text = dataGridView1.CurrentRow.Cells[11].Value.ToString();
                nyFormRedigeraPersonal.tbLösenord.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
                nyFormRedigeraPersonal.cbRoll.Text = dataGridView1.CurrentRow.Cells[13].Value.ToString();

                nyFormRedigeraPersonal.Show();
            }
            catch (Exception)
            {
        ...
        // Klick för att visa personal i listan
        private void btnVisa_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = bm.VisaPersonalRoll();
        }
    }
}
