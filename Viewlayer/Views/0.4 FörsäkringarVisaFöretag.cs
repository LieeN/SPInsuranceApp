...
{
    public partial class FormFörsäkringarVisaFöretag : Form
    {
        public FormFörsäkringarVisaFöretag()
        {
            InitializeComponent();
        ...
        private void pvdialogforetag_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnVisa_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bm.VisaFörsäkringFöretagsansökanFörsäkringstagare();
        }

        // Öppnar en ny form som tillåter redigering av värden
        private void btnRedigera_Click(object sender, EventArgs e)
        {
            try
            {
                FormRedigeraFöretagsFörsäkring nyFormRedigeraFöretagsFörsäkring = new FormRedigeraFöretagsFörsäkring();
                nyFormRedigeraFöretagsFörsäkring.tbFörsäkringsID.Text = dataGridView1.CurrentRow.Cells[0].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbOrgnr.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbFöretagsnamn.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbGatuadress.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbOrt.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbPostnr.Text = dataGridView1.CurrentRow.Cells[11].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbFörnamn.Text = dataGridView1.CurrentRow.Cells[7].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbEfternamn.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbTelnr.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbEpost.Text = dataGridView1.CurrentRow.Cells[13].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbFaxnr.Text = dataGridView1.CurrentRow.Cells[14].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbFörsäkringsbolag.Text = dataGridView1.CurrentRow.Cells[15].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.cbFörsäkringstyp.Text = dataGridView1.CurrentRow.Cells[16].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.dtpBegynnelsedatum.Text = dataGridView1.CurrentRow.Cells[19].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.dtpFörfallodag.Text = dataGridView1.CurrentRow.Cells[20].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.cbBetalningsform.Text = dataGridView1.CurrentRow.Cells[18].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbPremie.Text = dataGridView1.CurrentRow.Cells[17].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbAnteckning.Text = dataGridView1.CurrentRow.Cells[21].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbFörsäkringsnummer.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.dtpBetald.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbProvisionsbelopp.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                nyFormRedigeraFöretagsFörsäkring.tbAgenturnr.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();

                nyFormRedigeraFöretagsFörsäkring.Show();
            }
            catch (Exception)
            {
        ...
        private void btnSök_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bm.Sökförsäkringföretag(orgNr, FöretagsNamn);
        }
