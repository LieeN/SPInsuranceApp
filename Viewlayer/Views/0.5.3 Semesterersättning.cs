...
{
    public partial class FormSemesterersättning : Form
    {
        public FormSemesterersättning()
        {
            InitializeComponent();
        ...
        // Visar datagriden med värden
        private void btnVisa_Click(object sender, EventArgs e)
        {
            dataGridView25.DataSource = bm.VisaSemesterersättning();
        }

        // Öppnar en ny form med möjlighet att skapa en ny semesterersättning
        private void btnLäggTill_Click(object sender, EventArgs e)
        {
            FormSkapaSemesterersättning nySkapaSemesterersättning = new FormSkapaSemesterersättning();
            nySkapaSemesterersättning.Show();
        }

        // Loggar ut från nuvarande fönster
