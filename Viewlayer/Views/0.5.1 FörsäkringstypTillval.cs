...
{
    public partial class FormFörsäkringstypTillval : Form
    {
        public FormFörsäkringstypTillval()
        {
            InitializeComponent();
        ...
        //Öppnar fönstret som möjliggör att lägga till en försäkringstyp
        private void btnLäggTillFörsäkringstyp_Click(object sender, EventArgs e)
        {
            var LäggTillFörsäkringsTyp = new FormLäggTillFörsäkringsTyp(this);
            LäggTillFörsäkringsTyp.Show();
        }

        //Öppnar fönster som möjliggör att lägga till ett grundbelopp på en försäkringstyp
        private void btnLäggTillGrundbelopp_Click(object sender, EventArgs e)
        {
            FormLäggTillGrundbelopp nyLäggTillGrundbelopp = new FormLäggTillGrundbelopp();
            nyLäggTillGrundbelopp.tbFörsäkringsTyp.Text = cbFörsäkringstyper.Text.ToString();
            nyLäggTillGrundbelopp.Show();
        }

        //Öppnar fönstret som möjliggör att lägga till en tillvalstyp
        private void btnLäggTillTillval_Click(object sender, EventArgs e)
        {
            var LäggTillTillval = new FormLäggTillTillval(this);
            LäggTillTillval.Show();

        }

        //Öppnar fönster som möjliggör att lägga till ett grundbelopp på en tillvalstyp
        private void btnLäggTillTillvalsbelopp_Click(object sender, EventArgs e)
        {
            FormLäggTillTillvalsbelopp nyLäggTillTillvalsbelopp = new FormLäggTillTillvalsbelopp();
            nyLäggTillTillvalsbelopp.tbFormTillvalFörsäkringsId.Text = cbTillvalstyper.Text.ToString();
            nyLäggTillTillvalsbelopp.Show();

        }

        // Laddar in datasets
        private void FormFörsäkringstypTillval_Load(object sender, EventArgs e)
        {
            UpdateUI();
        }
        ...
        public void UpdateUI()
        {
            ...
            // TODO: This line of code loads data into the 'försäkringsTypTabellSet.FörsäkringsTypSet' table. You can move, or remove it, as needed.
            this.försäkringsTypSetTableAdapter.Fill(this.försäkringsTypTabellSet.FörsäkringsTypSet);
        }

        // Visa tillvalen i listan
        private void btnVisaTillval_Click(object sender, EventArgs e)
        {
            string Tillval = cbTillvalstyper.Text;
            dataGridView1.AutoGenerateColumns = false;
            dataGridView2.DataSource = bm.VisaTillvalTillvalsbelopp(Tillval);
        }

        // Visa försäkringstyperna i listan
        private void btnVisaFörsäkringstyp_Click(object sender, EventArgs e)
        {
            string FörsäkringsTyp = cbFörsäkringstyper.Text;
            dataGridView1.AutoGenerateColumns = false;
            dataGridView1.DataSource = bm.VisaFörsäkringTypsGrundbelopp(FörsäkringsTyp);
        }
