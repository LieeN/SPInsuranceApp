...
{
    public partial class FormPrivatRegister : Form
    {
        public FormPrivatRegister()
        {
            InitializeComponent();
        ...
        private void btnVisa_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bm.VisaPrivatregister();
        }

        // Öppnar en ny form med redigeringsmöjligheter
        private void btnRedigera_Click(object sender, EventArgs e)
        {
            try
            {
                FormRedigeraPrivatprofil nyFormRedigeraPrivatprofil = new FormRedigeraPrivatprofil();
                nyFormRedigeraPrivatprofil.tbID.Text = dataGridView1.CurrentRow.Cells[0].Value.ToString();
                nyFormRedigeraPrivatprofil.tbPersnr.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFnamn.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                nyFormRedigeraPrivatprofil.tbEnamn.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                nyFormRedigeraPrivatprofil.tbTelMobil.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
                nyFormRedigeraPrivatprofil.tbTelBostad.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
                nyFormRedigeraPrivatprofil.tbEpost.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                nyFormRedigeraPrivatprofil.tbEpost2.Text = dataGridView1.CurrentRow.Cells[7].Value.ToString();
                nyFormRedigeraPrivatprofil.tbGatuadress.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
                nyFormRedigeraPrivatprofil.tbOrt.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
                nyFormRedigeraPrivatprofil.tbPostnr.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFpersnr.Text = dataGridView1.CurrentRow.Cells[11].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFFnamn.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFEnamn.Text = dataGridView1.CurrentRow.Cells[13].Value.ToString();
                nyFormRedigeraPrivatprofil.cbVuxenBarn.Text = dataGridView1.CurrentRow.Cells[14].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFGatuadress.Text = dataGridView1.CurrentRow.Cells[15].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFOrt.Text = dataGridView1.CurrentRow.Cells[16].Value.ToString();
                nyFormRedigeraPrivatprofil.tbFpostnr.Text = dataGridView1.CurrentRow.Cells[17].Value.ToString();
                nyFormRedigeraPrivatprofil.Show();
            }
            catch (Exception)
            {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bm.sökPersonPrivatregister(persNr, eNamn);
        }
